...
date: 2025-11-29
draft: false
hidemeta: true  # Hides date/author (cleaner for an About page)
---

## The Polymath

I am a dual-degree student in **Computer Science** and **Mathematics**, building at the intersection of computational reasoning and physical discipline.

I am pursuing a never-ending quest to master both **Scientific Computing** and **Data Science**. These fields work in synergy within the professional scientific community, and are essential to my ambitions in the field of **Astrophysics**.

Once my two bachelor's degrees are completed, I plan to pursue post-baccalaureates in **Physics** and **Data Science**, eventually applying for a PhD in **Astrophysics** or specializing further in **Scientific Computing**. In the meantime, I continue to follow my path as a self-learner, acquiring specific certifications according to a thoroughly planned roadmap.
...
## The Temple (Physical Mastery)
I view the body as an instrument that must be tuned as finely as the mind. My training revolves around bodyweight mastery, although I incorporate weight training to maintain balanced development. Nothing brings me as much joy as the ability to freely control my body through space.
...
I am starting to share this journey at a moment where I am extremely close to achieving my main goals. Eventually, these targets will broaden to include world-class static hold skills. Thank you for tagging along!

![Suit Body Shot](/images/about_body.JPG)
